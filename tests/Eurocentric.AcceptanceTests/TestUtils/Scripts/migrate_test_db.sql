...
GO
CREATE UNIQUE INDEX [IX_country_contest_role_contest_id_country_id]
    ON [placeholder].[country_contest_role]([contest_id], [country_id]);


GO
CREATE INDEX [IX_country_contest_role_country_id]
    ON [placeholder].[country_contest_role]([country_id]);
...
GO
CREATE UNIQUE INDEX [IX_contest_broadcast_memo_contest_id_contest_stage]
    ON [placeholder].[contest_broadcast_memo]([contest_id], [contest_stage]);
