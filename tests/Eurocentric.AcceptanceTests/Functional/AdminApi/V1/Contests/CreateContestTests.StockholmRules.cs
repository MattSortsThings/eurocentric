...
public sealed partial class CreateContestTests
{
    ...
    public async Task Should_create_and_return_Stockholm_rules_contest_scenario_1(string apiVersion)
    {
        ...
        admin.Given_I_want_to_create_a_contest(
            contestRules: "Stockholm",
            contestYear: 2016,
            cityName: "Stockholm",
            participants: """
            | ParticipatingCountry | SemiFinalDraw | ActName            | SongTitle           |
            |----------------------|---------------|--------------------|---------------------|
            | AT                   | SemiFinal1    | ZOË                | Loin d'ici          |
            | BE                   | SemiFinal1    | Laura Tesoro       | What's The Pressure |
            | CZ                   | SemiFinal1    | Gabriela Gunčíková | I Stand             |
            | DK                   | SemiFinal2    | Lighthouse X       | Soldiers Of Love    |
            | EE                   | SemiFinal2    | Jüri Pootsmann     | Play                |
            | FI                   | SemiFinal2    | Sandhja            | Sing It Away        |
            """
        );
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_create_and_return_Stockholm_rules_contest_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_contest(
            ...
            | ParticipatingCountry | SemiFinalDraw | ActName               | SongTitle       |
            |----------------------|---------------|-----------------------|-----------------|
            | AT                   | SemiFinal2    | LUM!X feat. Pia Maria | Halo            |
            | BE                   | SemiFinal1    | Jérémie Makiese       | Miss You        |
            | CZ                   | SemiFinal2    | We Are Domi           | Lights Off      |
            | EE                   | SemiFinal1    | Stefan                | Hope            |
            | FI                   | SemiFinal2    | The Rasmus            | Jezebel         |
            | GB                   | SemiFinal2    | Sam Ryder             | SPACE MAN       |
            | HR                   | SemiFinal1    | Mia Dimšić            | Guilty Pleasure |
            | IT                   | SemiFinal1    | Mahmood & BLANCO      | Brividi         |
            """
        );
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_contest_year_conflict(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_contest_year(2025);
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_orphan_contest_country_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_countries(
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_orphan_contest_country_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_contest_year_value(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_contest_year(0);
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_city_name_value(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_city_name(" ");
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_act_name_value_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_act_names(
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_act_name_value_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_song_title_value_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
        ...
        admin.Given_I_want_to_create_a_Stockholm_rules_contest_with_song_titles(
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_song_title_value_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_contest_countries_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_contest_countries_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_contest_countries_scenario_3(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_global_televote(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_participant_counts_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_participant_counts_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_participant_counts_scenario_3(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    {
        public void Given_I_want_to_create_a_Stockholm_rules_contest_with_contest_year(int contestYear)
        {
            CreateContestRequest requestBody = DefaultStockholmRulesCreateCountryRequest() with
            {
        ...
        public void Given_I_want_to_create_a_Stockholm_rules_contest_with_city_name(string cityName)
        {
            CreateContestRequest requestBody = DefaultStockholmRulesCreateCountryRequest() with { CityName = cityName };

            Request = Kernel.Requests.Contests.CreateContest(requestBody);
        }

        public void Given_I_want_to_create_a_Stockholm_rules_contest_with_act_names(
            string[] semiFinal2ActNames = null!,
            string[] semiFinal1ActNames = null!
        )
        {
            CreateContestRequest defaultRequestBody = DefaultStockholmRulesCreateCountryRequest();
        ...
        public void Given_I_want_to_create_a_Stockholm_rules_contest_with_song_titles(
        ...
        public void Given_I_want_to_create_a_Stockholm_rules_contest_with_countries(
        ...
        private CreateContestRequest DefaultStockholmRulesCreateCountryRequest()
        {
