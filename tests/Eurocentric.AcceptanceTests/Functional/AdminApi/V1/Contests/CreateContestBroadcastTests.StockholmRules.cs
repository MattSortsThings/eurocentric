...
public sealed partial class CreateContestBroadcastTests
{
    ...
    public async Task Should_create_and_return_Stockholm_rules_SemiFinal1_broadcast(string apiVersion)
    {
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_create_and_return_Stockholm_rules_SemiFinal2_broadcast(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_create_and_return_Stockholm_rules_GrandFinal_broadcast(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_create_and_return_Stockholm_rules_broadcast_with_vacant_running_order_spot(
        string apiVersion
    )
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_contest_not_found(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_broadcast_date_conflict(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_child_broadcasts_conflict(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_year_conflict(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_participants_conflict_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_participants_conflict_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_participants_conflict_scenario_3(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_participants_conflict_scenario_4(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_parent_contest_participants_conflict_scenario_5(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_broadcast_date_value(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competing_countries(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competitors_count_scenario_1(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competitors_count_scenario_2(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competitors_count_scenario_3(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competitors_count_scenario_4(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Should_fail_on_Stockholm_rules_illegal_competitors_count_scenario_5(string apiVersion)
    {
        Admin admin = new(AdminKernel.Create(SystemUnderTest, apiVersion));
