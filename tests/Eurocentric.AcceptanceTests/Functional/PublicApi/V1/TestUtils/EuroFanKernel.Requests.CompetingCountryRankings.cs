...
public sealed partial class EuroFanKernel
{
    private sealed partial class RestRequestFactory : IRestRequestFactory.ICompetingCountryRankingsEndpoints
    {
        ...
        {
            return GetRequest("/public/api/{apiVersion}/competing-country-rankings/points-consensus")
                .UseDemoApiKey()
                .AddUrlSegment("apiVersion", apiVersion)
                .AddQueryParameters(queryParams);
        }
        ...
        {
            return GetRequest("/public/api/{apiVersion}/competing-country-rankings/points-in-range")
                .UseDemoApiKey()
                .AddUrlSegment("apiVersion", apiVersion)
                .AddQueryParameters(queryParams);
        }
