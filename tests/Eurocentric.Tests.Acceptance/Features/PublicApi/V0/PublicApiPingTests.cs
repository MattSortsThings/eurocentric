...
namespace Eurocentric.Tests.Acceptance.Features.PublicApi.V0;

[NotInParallel(nameof(PublicApiPingTests))]
public sealed class PublicApiPingTests : AcceptanceTests
{
    [Test]
    [Arguments("v0.1")]
    [Arguments("v0.2")]
    ...
    {
        // Arrange
        RestRequest request = GetRequest("/public/api/{apiVersion}/ping").AddUrlSegment("apiVersion", apiVersion);
