...
public sealed class CountryIdTests : UnitTest
{
    ...
    {
        // Arrange
        CountryId idA = CountryId.FromValue(Guid.Parse("aaaa8c81-dba0-4720-8ac9-3181cf9d26a1"));
        CountryId idB = CountryId.FromValue(Guid.Parse("bbbb8c81-dba0-4720-8ac9-3181cf9d26a1"));
        CountryId idC = CountryId.FromValue(Guid.Parse("cccc8c81-dba0-4720-8ac9-3181cf9d26a1"));
        CountryId idD = CountryId.FromValue(Guid.Parse("dddd8c81-dba0-4720-8ac9-3181cf9d26a1"));

        List<CountryId> sut = [idC, idB, idD, idA];

        // Act
        sut.Sort(Comparer<CountryId>.Default);
