...
public sealed class StockholmFormatContestTests : UnitTestBase
{
    ...
    public sealed class CreateSemiFinal1ChildBroadcastMethod : UnitTestBase
    {
        ...
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
        ...
        [Fact]
        public void Should_return_Broadcast_with_Jury_for_every_group_1_Participant_all_PointsAwarded_false()
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
                .WithContestYear(ContestYear2025)
            ...
            CountryId[] expectedJuryVotingCountryIds = [TestCountryIds.At, TestCountryIds.Be, TestCountryIds.Cz];
        ...
        [Fact]
        public void Should_return_Broadcast_with_Televote_for_every_group_1_Participant_all_PointsAwarded_false()
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
                .WithContestYear(ContestYear2025)
            ...
            CountryId[] expectedTelevotingCountryIds = [TestCountryIds.At, TestCountryIds.Be, TestCountryIds.Cz];
    ...
    public sealed class CreateSemiFinal2ChildBroadcastMethod : UnitTestBase
    {
        ...
        [Fact]
        public void Should_return_Broadcast_with_Jury_for_every_group_2_Participant_all_PointsAwarded_false()
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
                .WithContestYear(ContestYear2025)
            ...
            CountryId[] expectedJuryVotingCountryIds = [TestCountryIds.Dk, TestCountryIds.Ee, TestCountryIds.Fi];
        ...
        [Fact]
        public void Should_return_Broadcast_with_Televote_for_every_group_2_Participant_all_PointsAwarded_false()
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
                .WithContestYear(ContestYear2025)
            ...
            CountryId[] expectedTelevotingCountryIds = [TestCountryIds.Dk, TestCountryIds.Ee, TestCountryIds.Fi];
    ...
    public sealed class CreateGrandFinalChildBroadcastMethod : UnitTestBase
    {
        ...
        [Fact]
        public void Should_return_Broadcast_with_Jury_for_every_Participant_all_PointsAwarded_false()
        {
            // Arrange
            Contest sut = Contest.CreateStockholmFormat()
                .WithContestYear(ContestYear2025)
