...
public sealed class BroadcastTests : UnitTestBase
{
    public sealed class AwardTelevotePointsMethod : UnitTestBase
    {
        ...
        [Fact]
        public void Should_set_instance_BroadcastStatus_value_to_InProgress_once_any_Jury_or_Televote_has_false_PointsAwarded()
        {
            // Arrange
            Contest contest = Contest.CreateLiverpoolFormat()
                .WithContestYear(ContestYear2025)
        ...
        [Fact]
        public void Should_update_instance_BroadcastStatus_value_to_Completed_once_no_Jury_or_Televote_has_false_PointsAwarded()
        {
            // Arrange
            Contest contest = Contest.CreateLiverpoolFormat()
                .WithContestYear(ContestYear2025)
        ...
        public void Should_return_Errors_and_not_update_when_rankedCompetingCountryIds_contains_ID_matching_no_Competitor()
        {
            ...
            // Act
            ErrorOr<Updated> errorsOrUpdated = sut.AwardTelevotePoints(TestCountryIds.At, [TestCountryIds.At, wrongCountryId]);
