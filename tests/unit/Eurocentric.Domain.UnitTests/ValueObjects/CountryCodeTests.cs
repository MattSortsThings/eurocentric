...
public static class CountryCodeTests
{
    ...
    public sealed class FromValueStaticMethod : UnitTest
    {
        ...
        [InlineData("A")]
        [InlineData("AAA")]
        public void Should_return_Errors_given_string_of_length_not_equal_to_2(string value)
        {
            // Act
            ErrorOr<CountryCode> errorsOrResult = CountryCode.FromValue(value);
        ...
        [InlineData("11")]
        [InlineData(" A")]
        public void Should_return_Errors_given_string_with_non_upper_case_letter_char(string value)
        {
            // Act
            ErrorOr<CountryCode> errorsOrResult = CountryCode.FromValue(value);
