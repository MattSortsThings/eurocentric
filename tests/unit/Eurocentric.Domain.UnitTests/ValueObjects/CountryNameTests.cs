...
public static class CountryNameTests
{
    ...
    public sealed class FromValueStaticMethod : UnitTest
    {
        ...
        [Fact]
        public void Should_return_Errors_given_empty_string()
        {
            // Arrange
            const string value = "";
        ...
        [Fact]
        public void Should_return_Errors_given_all_whitespace_string()
        {
            // Arrange
            const string value = "        ";
        ...
        [Fact]
        public void Should_return_Errors_given_string_of_more_than_200_chars()
        {
            // Arrange
