...
public sealed partial class StockholmFormatContestTests
{
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_SemiFinal2_Broadcast_with_Competitors_in_specified_order()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_Jury_for_every_group_2_Participant()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_Televote_for_every_group_2_Participant()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Errors_when_broadcast_date_not_set()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
