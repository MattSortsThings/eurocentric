...
{
    [Test]
    public async Task SetChildBroadcastCompleted_should_set_ChildBroadcast_Completed_to_true()
    {
    ...
    [Test]
    public async Task SetChildBroadcastCompleted_should_set_Completed_to_false_when_fewer_than_3_ChildBroadcasts()
    {
        StockholmFormatContest sut = CreateContest(
            group1CountryIds: [AtId, BeId, CzId],
            group2CountryIds: [DkId, EeId, FiId]);
    ...
    [Test]
    public async Task SetChildBroadcastCompleted_should_set_Completed_to_false_when_3_ChildBroadcasts_still_not_all_Completed()
    {
        StockholmFormatContest sut = CreateContest(
            group1CountryIds: [AtId, BeId, CzId],
            group2CountryIds: [DkId, EeId, FiId]);
    ...
    [Test]
    public async Task SetChildBroadcastCompleted_should_set_Completed_to_true_when_3_ChildBroadcasts_now_all_Completed()
    {
        StockholmFormatContest sut = CreateContest(
            group1CountryIds: [AtId, BeId, CzId],
            group2CountryIds: [DkId, EeId, FiId]);
