...
public sealed partial class LiverpoolFormatContestTests
{
    ...
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_provided_BroadcastDate_and_Id(int contestYearValue,
        ...
        string broadcastIdValue)
    {
        ...
        CountryId[] arbitraryCompetingCountryIds = [DkId, EeId];

        // Act
        ErrorOr<Broadcast> result = sut.CreateSemiFinal2()
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_SemiFinal2_Broadcast_with_false_Completed_and_referencing_parent()
    {
        // Arrange
        ...
        await Assert.That(broadcast.ContestStage).IsEqualTo(ContestStage.SemiFinal2);
        await Assert.That(broadcast.Completed).IsFalse();
        await Assert.That(broadcast.ParentContestId).IsEqualTo(sut.Id);
    }

    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_Competitors_in_specified_order()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
        ...
        ErrorOr<Broadcast> result = sut.CreateSemiFinal2()
            .WithBroadcastDate(BroadcastDate2025May1)
            .WithCompetingCountryIds([EeId, DkId, FiId])
            .Build(() => FixedBroadcastId);
        ...
        await Assert.That(broadcast.Competitors).HasCount(3)
            .And.Contains(Matchers.InitializedCompetitor(EeId, runningOrderPosition: 1, finishingPosition: 1))
            .And.Contains(Matchers.InitializedCompetitor(DkId, runningOrderPosition: 2, finishingPosition: 2))
            .And.Contains(Matchers.InitializedCompetitor(FiId, runningOrderPosition: 3, finishingPosition: 3));
    }

    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_no_Juries()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Broadcast_with_Televote_for_every_group_0_and_2_Participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal21_Build_should_return_Errors_when_broadcast_date_not_set()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Errors_when_competitors_not_set()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Errors_when_instance_has_existing_SemiFinal2_ChildBroadcast()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
        ...
        await Assert.That(result.FirstError)
            ...
            .And.HasMetadataEntry("contestStage", "SemiFinal2");
    }

    [Test]
    [Arguments("2015-12-31")]
    [Arguments("2051-01-01")]
    public async Task CreateSemiFinal2_Build_should_return_Errors_given_illegal_broadcast_date_value(string broadcastDateValue)
    {
        // Arrange
    ...
    [Test]
    [MatrixDataSource]
    public async Task CreateSemiFinal2_Build_Should_return_Errors_given_broadcast_date_outside_contest_year(
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_Should_return_Errors_given_competing_country_ID_matching_group_0_participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
        ...
        ErrorOr<Broadcast> result = sut.CreateSemiFinal2()
            .WithBroadcastDate(BroadcastDate2025May1)
            .WithCompetingCountryIds([DkId, EeId, XxId])
            .Build(dummyIdProvider);
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_Should_return_Errors_given_competing_country_ID_matching_group_1_participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
        ...
        ErrorOr<Broadcast> result = sut.CreateSemiFinal2()
            .WithBroadcastDate(BroadcastDate2025May1)
            .WithCompetingCountryIds([DkId, EeId, AtId])
            .Build(dummyIdProvider);
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_Should_return_Errors_given_competing_country_ID_matching_no_participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_Should_return_Errors_given_duplicate_competing_country_IDs()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_return_Errors_given_fewer_than_2_competing_country_IDs()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateSemiFinal2_WithCompetingCountryIds_should_throw_given_null_competingCountryIds_arg()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(
            group0CountryId: XxId,
        ...
        Action act = () => sut.CreateSemiFinal2().WithCompetingCountryIds(null!);
    ...
    [Test]
    public async Task CreateSemiFinal2_Build_should_throw_given_null_idProvider_arg()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(
            group0CountryId: XxId,
        ...
        Action act = () => sut.CreateSemiFinal2().Build(null!);
