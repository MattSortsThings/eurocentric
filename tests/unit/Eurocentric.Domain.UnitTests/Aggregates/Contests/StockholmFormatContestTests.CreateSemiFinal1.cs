...
public sealed partial class StockholmFormatContestTests
{
    ...
    [Test]
    public async Task CreateSemiFinal1_Build_should_return_SemiFinal1_Broadcast_with_Competitors_in_specified_order()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
    ...
    [Test]
    public async Task CreateSemiFinal1_Build_should_return_Broadcast_with_Jury_for_every_group_1_Participant()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
    ...
    [Test]
    public async Task CreateSemiFinal1_Build_should_return_Broadcast_with_Televote_for_every_group_1_Participant()
    {
        // Arrange
        StockholmFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group1CountryIds: [AtId, BeId, CzId],
