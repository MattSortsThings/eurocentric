...
public sealed partial class LiverpoolFormatContestTests
{
        ...
        string broadcastIdValue)
    {
        ...
        CountryId[] arbitraryCompetingCountryIds = [AtId, EeId];
    ...
    [Test]
    public async Task CreateGrandFinal_Build_should_return_Broadcast_with_Jury_for_every_group_1_and_2_Participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
    ...
    [Test]
    public async Task CreateGrandFinal_Build_Should_return_Errors_given_competing_country_ID_matching_group_0_participant()
    {
        // Arrange
        LiverpoolFormatContest sut = CreateContest(contestYear: ContestYear2025,
            group0CountryId: XxId,
