...
/// <summary>
///     A set of seven named <see cref="CountryId" /> values whose sort order matches their property names.
/// </summary>
public sealed record SevenCountryIds
{
    ...
    public void Deconstruct(out CountryId at, out CountryId be, out CountryId cz, out CountryId dk, out CountryId ee,
        out CountryId fi, out CountryId gb)
    {
        at = At;
        be = Be;
        cz = Cz;
