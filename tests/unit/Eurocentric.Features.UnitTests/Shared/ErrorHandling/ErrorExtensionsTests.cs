...
{
    public sealed class ToProblemHttpResultExtensionMethod : UnitTest
    {
        private const string TestValue = "Cha Cha Cha";

        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_422_when_instance_ErrorType_is_Failure()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_500_when_instance_ErrorType_is_Unexpected()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_400_when_instance_ErrorType_is_Validation()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_409_when_instance_ErrorType_is_Conflict()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_404_when_instance_ErrorType_is_NotFound()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_401_when_instance_ErrorType_is_Unauthorized()
        {
            // Arrange
        ...
        [Test]
        public async Task Should_return_ProblemHttpResult_with_status_code_403_when_instance_ErrorType_is_Forbidden()
        {
            // Arrange
