...
public sealed class ErrorOrExtensionsTests : UnitTestBase
{
    ...
    [Fact]
    public async Task Should_return_mapped_value_when_instance_is_not_error()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Failure_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Unexpected_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Validation_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Conflict_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_NotFound_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Unauthorized_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_return_ProblemHttpResult_when_instance_first_error_has_Forbidden_type()
    {
        // Arrange
    ...
    [Fact]
    public async Task Should_throw_given_null_valueMapper_arg()
    {
        // Arrange
        ErrorOr<string> sut = ErrorOrFactory.From(Value);
        ...
        Assert.Equal("Value cannot be null. (Parameter 'valueMapper')", exception.Message);
    }
}
