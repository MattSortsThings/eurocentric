...
{
    protected ActorWithResponse(IPublicApiV0Driver apiDriver)
    {
        ApiDriver = apiDriver;
    ...
    private protected Func<IPublicApiV0Driver, Task<ProblemOrResponse<TResponse>>> SendMyRequest { get; set; }
