...
namespace Eurocentric.Features.AcceptanceTests.PublicApi.V1.Rankings.CompetingCountries;
...
public sealed class GetCompetingCountryPointsConsensusRankingsTests : ParallelSeededAcceptanceTest
{
        ...
        : EuroFanActorWithResponse<GetCompetingCountryPointsConsensusRankingsResponse>(apiDriver)
    {
            ...
            string? contestStage = null)
        {
            ...
            Request = ApiDriver.RequestFactory.CompetingCountryRankings.GetCompetingCountryPointsConsensusRankings(queryParams);
        }
        ...
        public async Task Then_the_response_query_metadata_should_match(
            ...
            string contestStage = "")
        {
            (_, CompetingCountryPointsConsensusQueryMetadata query, _) = await Assert.That(ResponseBody).IsNotNull();

            CompetingCountryPointsConsensusQueryMetadata expectedQuery = new()
            {
