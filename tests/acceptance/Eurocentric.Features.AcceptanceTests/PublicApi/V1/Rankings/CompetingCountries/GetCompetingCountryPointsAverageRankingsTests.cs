...
public sealed class GetCompetingCountryPointsAverageRankingsTests : ParallelSeededAcceptanceTest
{
        ...
        : EuroFanActorWithResponse<GetCompetingCountryPointsAverageRankingsResponse>(apiDriver)
    {
            ...
            string? contestStage = null)
        {
            ...
            Request = ApiDriver.RequestFactory.CompetingCountryRankings.GetCompetingCountryPointsAverageRankings(queryParams);
        }
        ...
        public async Task Then_the_response_query_metadata_should_match(string votingMethod = "",
            ...
            string contestStage = "")
        {
            (_, CompetingCountryPointsAverageQueryMetadata query, _) = await Assert.That(ResponseBody).IsNotNull();

            CompetingCountryPointsAverageQueryMetadata expectedQuery = new()
            {
