...
internal sealed class CompetitorEqualityComparer : IEqualityComparer<Competitor>
{
    ...
    public int GetHashCode(Competitor obj) => HashCode.Combine(obj.CompetingCountryId, obj.RunningOrderPosition,
        obj.FinishingPosition, obj.TelevoteAwards, obj.JuryAwards);
}
