...
public sealed class AwardTelevotePointsTests(WebAppFixture fixture) : AcceptanceTestBase(fixture)
{
    ...
    public async Task Should_be_able_to_award_points_for_televote_in_broadcast_scenario_1(string apiVersion)
    {
        ...
        await admin.Given_I_have_created_the_SemiFinal1_child_broadcast_for_my_contest_with_competing_countries("AT", "BE",
            "CZ");
    ...
    private sealed class AdminActor : ActorWithoutResponse
    {
        ...
        public async Task Given_I_have_created_the_SemiFinal1_child_broadcast_for_my_contest_with_competing_countries(
            ...
            string votingCountryCode = "")
        {
            ...
            _ = await ApiDriver.Broadcasts.AwardTelevotePoints(myBroadcastId, requestBody,
                TestContext.Current.CancellationToken);
        }
