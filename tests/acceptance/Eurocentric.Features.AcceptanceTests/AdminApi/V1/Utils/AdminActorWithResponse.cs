...
public abstract class AdminActorWithResponse<TResponse> : IAdminActor, IResponseVerifier<TResponse> where TResponse : class
{
    ...
    public AdminActorWithResponse(IWebAppFixtureRestClient restClient,
    ...
    public async Task When_I_send_my_request()
    {
        ...
        ProblemOrResponse<TResponse> responseOrProblem =
            await RestClient.SendAsync<TResponse>(Request, TestContext.Current.CancellationToken);
