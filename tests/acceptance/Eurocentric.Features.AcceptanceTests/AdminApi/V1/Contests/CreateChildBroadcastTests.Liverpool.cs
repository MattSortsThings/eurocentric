...
public sealed partial class CreateChildBroadcastTests
{
    ...
    public async Task Endpoint_should_create_and_return_Liverpool_format_contest_SemiFinal1_broadcast_and_update_contest(
        string apiVersion)
    {
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_create_and_return_Liverpool_format_contest_SemiFinal2_broadcast_and_update_contest(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_create_and_return_Liverpool_format_contest_GrandFinal_broadcast_and_update_contest(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal1_child_broadcast_when_SemiFinal1_exists(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_have_created_a_Liverpool_format_contest_for_my_countries(contestYear: 2023,
            ...
            group1CountryCodes: ["AT", "BE", "CZ"],
            group2CountryCodes: ["DK", "EE", "FI"]);
        await admin.Given_I_have_created_a_SemiFinal1_broadcast_for_my_contest_with_broadcast_date("2023-05-31");

        await admin.Given_I_want_to_create_a_SemiFinal1_child_broadcast_for_my_contest_with_broadcast_date("2023-05-02");
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal2_child_broadcast_when_SemiFinal2_exists(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_have_created_a_Liverpool_format_contest_for_my_countries(contestYear: 2023,
            ...
            group1CountryCodes: ["AT", "BE", "CZ"],
            group2CountryCodes: ["DK", "EE", "FI"]);
        await admin.Given_I_have_created_a_SemiFinal2_broadcast_for_my_contest_with_broadcast_date("2023-05-31");

        await admin.Given_I_want_to_create_a_SemiFinal2_child_broadcast_for_my_contest_with_broadcast_date("2023-05-02");
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_GrandFinal_child_broadcast_when_GrandFinal_exists(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_have_created_a_Liverpool_format_contest_for_my_countries(contestYear: 2023,
            ...
            group1CountryCodes: ["AT", "BE", "CZ"],
            group2CountryCodes: ["DK", "EE", "FI"]);
        await admin.Given_I_have_created_a_GrandFinal_broadcast_for_my_contest_with_broadcast_date("2023-05-31");

        await admin.Given_I_want_to_create_a_GrandFinal_child_broadcast_for_my_contest_with_broadcast_date("2023-05-03");
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_non_unique_broadcast_date(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_have_created_a_Liverpool_format_contest_for_my_countries(contestYear: 2023,
            ...
            group1CountryCodes: ["AT", "BE", "CZ"],
            group2CountryCodes: ["DK", "EE", "FI"]);
        await admin.Given_I_have_created_a_SemiFinal1_broadcast_for_my_contest_with_broadcast_date("2023-05-17");

        await admin.Given_I_want_to_create_a_GrandFinal_child_broadcast_for_my_contest_with_broadcast_date("2023-05-17");
        ...
        await admin.Then_the_response_problem_details_extensions_should_include_the_broadcast_date("2023-05-17");
        await admin.Then_my_contest_should_be_unchanged();
        await admin.Then_my_given_broadcast_should_be_the_only_existing_broadcast_in_the_system();
    }
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_illegal_broadcast_date_value(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_want_to_create_a_SemiFinal1_child_broadcast_for_my_contest_with_broadcast_date("1900-01-01");
        ...
        await admin.Then_the_response_problem_details_extensions_should_include_the_broadcast_date("1900-01-01");
        await admin.Then_my_contest_should_be_unchanged();
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_broadcast_date_out_of_range(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_want_to_create_a_SemiFinal1_child_broadcast_for_my_contest_with_broadcast_date("2024-01-01");
        ...
        await admin.Then_the_response_problem_details_extensions_should_include_the_broadcast_date("2024-01-01");
        await admin.Then_my_contest_should_be_unchanged();
        await admin.Then_no_broadcasts_should_exist_in_the_system();
    }
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_orphan_competing_country_ID(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal1_child_broadcast_with_group_0_competitor(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal1_child_broadcast_with_group_2_competitor(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal2_child_broadcast_with_group_0_competitor(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_SemiFinal2_child_broadcast_with_group_1_competitor(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_GrandFinal_child_broadcast_with_group_0_competitor(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
        ...
        await admin.Given_I_want_to_create_a_GrandFinal_child_broadcast_for_my_contest_with_competing_countries(
            "AT", "FI", "XX");
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_duplicate_competing_country_IDs(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
    ...
    [Test]
    [ApiVersion1Point0AndUp]
    public async Task Endpoint_should_fail_on_Liverpool_format_contest_child_broadcast_with_fewer_than_two_competitors(
        string apiVersion)
    {
        AdminActor admin = new(ApiDriver.Create(SystemUnderTest, apiVersion));
