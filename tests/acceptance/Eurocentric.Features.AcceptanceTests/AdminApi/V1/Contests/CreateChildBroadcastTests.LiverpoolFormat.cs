...
public static partial class CreateChildBroadcastTests
{
    public sealed partial class Endpoint
    {
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_create_and_return_SemiFinal1_child_broadcast_for_Liverpool_format_contest_and_update_contest(
            string apiVersion)
        {
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_create_and_return_SemiFinal2_child_broadcast_for_Liverpool_format_contest_and_update_contest(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_create_and_return_GrandFinal_child_broadcast_for_Liverpool_format_contest_and_update_contest(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_child_broadcast_with_non_unique_contest_stage(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_child_broadcast_with_broadcast_date_out_of_range(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_child_broadcast_with_orphan_competing_country_ID(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_SemiFinal1_child_broadcast_with_group_0_competitor(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
            ...
            await admin.Given_I_have_created_a_Liverpool_format_contest(contestYear: 2025,
                ...
                group1CountryCodes: ["AT", "BE", "CZ"],
                group2CountryCodes: ["DK", "EE", "FI"]);
            admin.Given_I_want_to_create_a_SemiFinal1_child_broadcast_for_my_contest_with_competing_countries("AT", "XX");
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_SemiFinal1_child_broadcast_with_group_2_competitor(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_SemiFinal2_child_broadcast_with_group_0_competitor(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
            ...
            await admin.Given_I_have_created_a_Liverpool_format_contest(contestYear: 2025,
                ...
                group1CountryCodes: ["AT", "BE", "CZ"],
                group2CountryCodes: ["DK", "EE", "FI"]);
            admin.Given_I_want_to_create_a_SemiFinal2_child_broadcast_for_my_contest_with_competing_countries("DK", "XX");
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_SemiFinal2_child_broadcast_with_group_1_competitor(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_GrandFinal_child_broadcast_with_group_0_competitor(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
            ...
            await admin.Given_I_have_created_a_Liverpool_format_contest(contestYear: 2025,
                ...
                group1CountryCodes: ["AT", "BE", "CZ"],
                group2CountryCodes: ["DK", "EE", "FI"]);
            admin.Given_I_want_to_create_a_GrandFinal_child_broadcast_for_my_contest_with_competing_countries("AT", "XX");
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_child_broadcast_with_duplicate_competing_country_IDs(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
        ...
        [Theory]
        [InlineData("v1.0")]
        public async Task Should_fail_on_Liverpool_format_contest_child_broadcast_with_fewer_than_two_competitors(
            string apiVersion)
        {
            Admin admin = new(RestClient, BackDoor, RequestFactory.WithApiVersion(apiVersion));
