...
public abstract class GetContestTests : AcceptanceTestBase
{
    ...
    public async Task Should_be_able_to_retrieve_a_contest_by_its_ID()
    {
        ...
        // Given
        euroFan.Given_I_want_to_retrieve_the_contest_with_id("9fe06015-eeeb-4e0b-9446-767b161caeed");
        ...
        euroFan.Then_the_retrieved_contest_should_have_my_target_contest_ID();
    }
