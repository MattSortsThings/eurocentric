...
public sealed class PublicApiSecurityTests(WebAppFixture fixture) : AcceptanceTestBase(fixture)
{
    private const string GetAvailableVotingMethodsRoute = "/public/api/v0.2/filters/voting-methods";
