...
public sealed class GlobalExceptionHandlingTests(WebAppFixture webAppFixture) : AcceptanceTestBase(webAppFixture)
{
    ...
    {
        // Arrange
        RestRequest restRequest = Post("admin/api/v0.2/stations").AddJsonBody(new { MalformedRequest = true });
    ...
    {
        // Arrange
        RestRequest restRequest = Get("public/api/v0.1/stations").AddQueryParameter("line", 999999);
