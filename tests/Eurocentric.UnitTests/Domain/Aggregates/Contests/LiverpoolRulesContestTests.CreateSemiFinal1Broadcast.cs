...
public sealed partial class LiverpoolRulesContestTests
{
    ...
    public async Task CreateSemiFinal1Broadcast_Build_Build_should_return_Broadcast_with_specified_ID(
    ...
    public async Task CreateSemiFinal1Broadcast_Build_Build_should_return_Broadcast_with_specified_BroadcastDate(
    ...
    [Arguments("26786949-965a-44cc-801a-22c6b5667a3b")]
    [Arguments("cbafd594-551e-4d87-8089-a8450d4ad059")]
    public async Task CreateSemiFinal1Broadcast_Build_Build_should_return_Broadcast_with_instance_ID_as_ParentContestId(
    ...
    [Test]
    public async Task CreateSemiFinal1Broadcast_Build_Build_should_return_Broadcast_with_SemiFinal1_ContestStage()
    {
        // Arrange
        LiverpoolRulesContest sut = CreateALiverpoolRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal1Broadcast_Build_Build_should_return_Broadcast_with_false_Completed()
    {
        // Arrange
        LiverpoolRulesContest sut = CreateALiverpoolRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal1Broadcast_Build_should_return_Broadcast_with_no_Juries()
    {
        // Arrange
        LiverpoolRulesContest sut = CreateALiverpoolRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal1Broadcast_Build_should_fail_on_parent_contest_participants_conflict_scenario_3()
    {
        // Arrange
        IBroadcastIdFactory spyIdFactory = Substitute.For<IBroadcastIdFactory>();
        ...
        Result<Broadcast, IDomainError> result = sut.CreateSemiFinal1Broadcast()
            .WithBroadcastDate(BroadcastDate2016JanFirst)
            .WithCompetingCountries(CountryIds.At, CountryIds.Be, CountryIds.Xx)
            .Build(spyIdFactory.Create);
