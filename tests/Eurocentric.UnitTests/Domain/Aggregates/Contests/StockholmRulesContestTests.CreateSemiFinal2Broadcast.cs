...
public sealed partial class StockholmRulesContestTests
{
    ...
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_specified_ID(string broadcastIdValue)
    {
        // Arrange
    ...
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_specified_BroadcastDate(
    ...
    [Arguments("26786949-965a-44cc-801a-22c6b5667a3b")]
    [Arguments("cbafd594-551e-4d87-8089-a8450d4ad059")]
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_instance_ID_as_ParentContestId(
    ...
    [Test]
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_SemiFinal2_ContestStage()
    {
        // Arrange
        StockholmRulesContest sut = CreateAStockholmRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_false_Completed()
    {
        // Arrange
        StockholmRulesContest sut = CreateAStockholmRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_correct_Juries()
    {
        // Arrange
        StockholmRulesContest sut = CreateAStockholmRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal2Broadcast_Build_should_return_Broadcast_with_BroadcastCreatedEvent()
    {
        // Arrange
        StockholmRulesContest sut = CreateAStockholmRulesContest(
            contestYear: ContestYear2016,
    ...
    [Test]
    public async Task CreateSemiFinal2Broadcast_Build_should_fail_on_parent_contest_child_broadcasts_conflict()
    {
        // Arrange
        IBroadcastIdFactory spyIdFactory = Substitute.For<IBroadcastIdFactory>();
        ...
        sut.AddChildBroadcast(DefaultBroadcastId, ContestStage.SemiFinal2);
