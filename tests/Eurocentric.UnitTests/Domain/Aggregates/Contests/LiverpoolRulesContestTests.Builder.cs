...
public sealed partial class LiverpoolRulesContestTests
{
    ...
    public async Task Builder_should_return_LiverpoolRulesContest_with_specified_ID(string contestIdValue)
    {
        // Arrange
        ...
        await Assert
            .That(result.Value)
            .IsTypeOf<LiverpoolRulesContest>()
    ...
    [Arguments(2025)]
    [Arguments(2050)]
    public async Task Builder_should_return_LiverpoolRulesContest_with_specified_ContestYear(int contestYearValue)
    {
        // Arrange
    ...
    [Arguments("Liverpool")]
    [Arguments("Tel Aviv")]
    public async Task Builder_should_return_LiverpoolRulesContest_with_specific_CityName(string cityNameValue)
    {
        // Arrange
    ...
    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_Liverpool_ContestRules()
    {
        // Act
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            .Create()
        ...
        await Assert
            .That(result.Value)
            .IsTypeOf<LiverpoolRulesContest>()
            .And.HasProperty(contest => contest.ContestRules, ContestRules.Liverpool); // Act
    }

    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_false_Queryable()
    {
        // Act
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            .Create()
    ...
    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_empty_ChildBroadcasts()
    {
        // Act
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            .Create()
        ...
        LiverpoolRulesContest contest = await Assert
            .That(result.Value)
            .IsTypeOf<LiverpoolRulesContest>()
            .And.IsNotNull();
    ...
    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_specified_GlobalTelevote()
    {
        // Arrange
        CountryId countryId = CountryId.FromValue(Guid.Parse("b647b379-734c-432b-a32d-23be3eaeacf2"));
        ...
        await Assert
            .That(contest.GlobalTelevote)
            .IsNotNull()
            .And.HasProperty(televote => televote.VotingCountryId, countryId);
    }

    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_specified_Participants()
    {
        // Act
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            .Create()
    ...
    [Test]
    public async Task Builder_should_return_LiverpoolRulesContest_with_ContestCreatedEvent()
    {
        // Act
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            .Create()
        ...
        LiverpoolRulesContest createdContest = await Assert
            .That(result.Value)
            .IsTypeOf<LiverpoolRulesContest>()
            .And.IsNotNull();
    ...
    [Test]
    public async Task Builder_should_fail_on_participant_and_global_televote_referencing_same_country_scenario_1()
    {
        // Arrange
        IContestIdFactory idFactorySpy = Substitute.For<IContestIdFactory>();
    ...
    [Test]
    public async Task Builder_should_fail_on_participant_and_global_televote_referencing_same_country_scenario_2()
    {
        // Arrange
        IContestIdFactory idFactorySpy = Substitute.For<IContestIdFactory>();
        ...
        Result<Contest, IDomainError> result = LiverpoolRulesContest
            ...
            .AddSemiFinal2Participant(CountryIds.Ee, DefaultActName, DefaultSongTitle)
            .AddSemiFinal2Participant(CountryIds.Fi, DefaultActName, DefaultSongTitle)
            .AddSemiFinal2Participant(CountryIds.Xx, DefaultActName, DefaultSongTitle)
            .Build(idFactorySpy.Create);
    ...
    [Test]
    public async Task Builder_should_fail_on_null_global_televote()
    {
        // Arrange
        IContestIdFactory idFactorySpy = Substitute.For<IContestIdFactory>();
    ...
    public async Task Builder_WithGlobalTelevote_should_throw_given_null_countryId_arg()
    {
        // Assert
        await Assert
            .That(() => LiverpoolRulesContest.Create().WithGlobalTelevote(null!))
    ...
    public async Task Builder_AddSemiFinal1Participant_should_throw_given_null_countryId_arg()
    {
        ...
        await Assert
            .That(() =>
                LiverpoolRulesContest.Create().AddSemiFinal1Participant(null!, DefaultActName, DefaultSongTitle)
            )
            .Throws<ArgumentNullException>()
            .WithMessage("Value cannot be null. (Parameter 'countryId')");
    }
    ...
    public async Task Builder_AddSemiFinal2Participant_should_throw_given_null_countryId_arg()
    {
        ...
        await Assert
            .That(() =>
                LiverpoolRulesContest.Create().AddSemiFinal2Participant(null!, DefaultActName, DefaultSongTitle)
            )
            .Throws<ArgumentNullException>()
            .WithMessage("Value cannot be null. (Parameter 'countryId')");
    }
    ...
    public async Task Builder_Build_should_throw_given_null_idProvider_arg()
    {
        // Assert
        await Assert
            .That(() => LiverpoolRulesContest.Create().Build(null!))
            .Throws<ArgumentNullException>()
