...
{
    [Test]
    public async Task AddGlobalTelevoteContestRole_should_add_ContestRole()
    {
        // Arrange
        Country sut = Country
            .Create()
        ...
        await Assert
            ...
            .And.HasProperty(role => role.ContestRoleType, ContestRoleType.GlobalTelevote);
    }

    [Test]
    public async Task AddGlobalTelevoteContestRole_should_throw_given_null_contestId_arg()
    {
        // Arrange
        Country sut = Country
            .Create()
        ...
        // Assert
        await Assert
            .That(() => sut.AddGlobalTelevoteContestRole(nullContestId))
    ...
    [Test]
    public async Task AddGlobalTelevoteContestRole_should_throw_on_contest_ID_conflict_scenario_1()
    {
        // Arrange
        Country sut = Country
            .Create()
        ...
        // Assert
        await Assert
            .That(() => sut.AddGlobalTelevoteContestRole(contestId))
    ...
    [Test]
    public async Task AddGlobalTelevoteContestRole_should_throw_on_contest_ID_conflict_scenario_2()
    {
        // Arrange
        Country sut = Country
            .Create()
