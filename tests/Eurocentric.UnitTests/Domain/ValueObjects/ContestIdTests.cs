...
public sealed class ContestIdTests : UnitTest
{
    ...
    [Test]
    public async Task CompareTo_should_return_0_when_other_is_instance()
    {
        // Arrange
        ContestId sut = ContestId.FromValue(ArbitraryValue);
    ...
    [Test]
    public async Task Equals_should_return_true_when_other_is_ContestId_with_equal_Value()
    {
        // Arrange
    ...
    [Test]
    public async Task Equals_should_return_false_when_other_is_ContestId_with_unequal_Value()
    {
        // Arrange
        Guid sutValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
    ...
    [Test]
    public async Task Equals_should_return_false_when_other_is_not_ContestId()
    {
        // Arrange
        Guid sharedValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
    ...
    [Test]
    public async Task Equality_operator_should_return_true_when_other_is_ContestId_with_equal_Value()
    {
        // Arrange
        Guid sharedValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
    ...
    [Test]
    public async Task Equality_operator_should_return_false_when_other_is_ContestId_with_unequal_Value()
    {
        // Arrange
        Guid sutValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
        Guid otherValue = Guid.Parse("cbafd594-551e-4d87-8089-a8450d4ad059");
    ...
    [Test]
    public async Task Equality_operator_should_return_false_when_other_is_not_ContestId()
    {
        // Arrange
        Guid sharedValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
    ...
    [Test]
    public async Task Inequality_operator_should_return_false_when_other_is_ContestId_with_equal_Value()
    {
        // Arrange
        Guid sharedValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
    ...
    [Test]
    public async Task Inequality_operator_should_return_true_when_other_is_ContestId_with_unequal_Value()
    {
        // Arrange
        Guid sutValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
        Guid otherValue = Guid.Parse("cbafd594-551e-4d87-8089-a8450d4ad059");
    ...
    [Test]
    public async Task Inequality_operator_should_return_true_when_other_is_not_ContestId()
    {
        // Arrange
        Guid sharedValue = Guid.Parse("26786949-965a-44cc-801a-22c6b5667a3b");
