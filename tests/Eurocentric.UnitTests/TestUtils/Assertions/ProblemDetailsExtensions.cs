...
public static class ProblemDetailsExtensions
{
    ...
    public static ProblemDetailsHasEmptyExtensionsAssertion HasEmptyExtensions(
        this IAssertionSource<ProblemDetails> source
    )
    {
        source.Context.ExpressionBuilder.Append(".HasEmptyExtensions()");

        return new ProblemDetailsHasEmptyExtensionsAssertion(source.Context);
    }
    ...
    public static ProblemDetailsHasNullInstanceAssertion HasNullInstance(this IAssertionSource<ProblemDetails> source)
    {
        source.Context.ExpressionBuilder.Append(".HasNullInstance()");

        return new ProblemDetailsHasNullInstanceAssertion(source.Context);
    }
