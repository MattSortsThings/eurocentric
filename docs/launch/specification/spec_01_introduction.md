...
*Eurocentric*, alias "the system", is composed of two APIs - the Public API and the Admin API - with a shared domain and database.
...
- The Public API is rate limited for all users except the Admin.

**OpenAPI** functionality:

- The system serves an OpenAPI JSON document for each version of each API.
- The system serves a documentation web page based on each OpenAPI document.
...
| ne##   | Non-functional   | *errors*      |
| nl##   | Non-functional   | *limiting*    |
