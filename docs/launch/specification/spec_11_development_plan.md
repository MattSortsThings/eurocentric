...
2. Implement non-functional features (feature scopes: *errors*, *limiting*, *open-api*, *security* and *versioning*).

### 2. Admin API v1.0

1. Define version 1.0 of the Admin API
2. Implement all functional features with *admin-api* feature scope.

### 3. Public API v1.0

1. Define version 1.0 of the Public API
2. Implement all functional features with *public-api* feature scope.
...
A GitHub action executes the following jobs on every push to the remote repository main branch:

- publish:
  - Build the solution.
  - Run all tests in the solution.
  - Publish the `Eurocentric.WebApp` web application.
- deploy:
  - Deploy the web application to the Azure Web App service.
