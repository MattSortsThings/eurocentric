...
- [4. Functional requirements](#4-functional-requirements)
  ...
  - [*public-api* feature scope](#public-api-feature-scope)
    ...
    - [Results](#results)
      - [fp12: Get detailed results](#fp12-get-detailed-results)
      - [fp13: Get summary results](#fp13-get-summary-results)
    - [Voting country rankings](#voting-country-rankings)
      - [fp14: Get voting country points average rankings](#fp14-get-voting-country-points-average-rankings)
      - [fp15: Get voting country points consensus rankings](#fp15-get-voting-country-points-consensus-rankings)
      - [fp16: Get voting country points in range rankings](#fp16-get-voting-country-points-in-range-rankings)
      - [fp17: Get voting country points share rankings](#fp17-get-voting-country-points-share-rankings)
...
#### fp12: Get detailed results

- As a EuroFan
- I want to retrieve the detailed results for a single country in a broadcast
  - specifying
    - the contest year
    - the contest stage
    - the country code
  - receiving data that replicates a broadcast's "detailed voting results" page on the official Eurovision website
- So that I can see all the points the country received and/or gave in the broadcast.

#### fp13: Get summary results

- As a EuroFan
- I want to retrieve the summary results for a broadcast
  - specifying
    - the contest year
    - the contest stage
  - receiving data that replicates a broadcast's "scoreboard" page on the official Eurovision website
- So that I can get an overview of how all the points were distributed in the broadcast.

### Voting country rankings

#### fp14: Get voting country points average rankings

- As a EuroFan
- I want to rank each voting country by descending points average
  - i.e. the average individual points value it awarded to a defined country across broadcasts
  - specifying
...
#### fp15: Get voting country points consensus rankings
...
#### fp16: Get voting country points in range rankings
...
#### fp17: Get voting country points share rankings
