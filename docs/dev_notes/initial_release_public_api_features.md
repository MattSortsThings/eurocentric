...
- [Initial release: *public-api* features](#initial-release-public-api-features)
  ...
  - [Voting Country Rankings](#voting-country-rankings)
    - [P15: Get Points Average Voting Country Rankings](#p15-get-points-average-voting-country-rankings)
    - [P16: Get Points Consensus Voting Country Rankings](#p16-get-points-consensus-voting-country-rankings)
    - [P17: Get Points In Range Voting Country Rankings](#p17-get-points-in-range-voting-country-rankings)
    - [P18: Get Points Share Voting Country Rankings](#p18-get-points-share-voting-country-rankings)
...
### P15: Get Points Average Voting Country Rankings
...
### P16: Get Points Consensus Voting Country Rankings
...
### P17: Get Points In Range Voting Country Rankings
...
### P18: Get Points Share Voting Country Rankings
