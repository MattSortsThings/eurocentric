# 4. Initial release: *admin-api* features

This document lists the features with *admin-api* scope for the initial release of *Eurocentric*.

- [4. Initial release: *admin-api* features](#4-initial-release-admin-api-features)
...
- **I WANT** to create a new contest in the system
  - providing
    ...
    - and the participants, for each:
      - its participating country ID
      - and its semi-final draw
      - and its act name
      - and its song title
...
- **I WANT** to create a child broadcast for a contest in the system
  - providing
    ...
    - and the competing country IDs in running order
...
- **AS** the *Admin*
  - who has just modified a broadcast causing its to become completed
