...
- [06: Features: *error-handling* scope](#06-features-error-handling-scope)
  - [Errors](#errors)
    - [ce01: Problem Details Responses](#ce01-problem-details-responses)
  - [Exceptions](#exceptions)
    - [ce02: Global Exception Handling](#ce02-global-exception-handling)
    - [ce03: Database Timeout Handling](#ce03-database-timeout-handling)

## Errors

### ce01: Problem Details Responses
...
### ce02: Global Exception Handling
...
### ce03: Database Timeout Handling

**Details:**

- A custom `DatabaseTimeoutException` is defined.
- When an `SqlException` is thrown on the server while handling an API HTTP request because the database is temporarily unavailable, this is caught and a `DatabaseTimeoutException` is thrown.
