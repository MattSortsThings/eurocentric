...
*Eurocentric* is a web API for modelling and (over)analysing the Eurovision Song Contest, 2016-present.
...
|:-------|:-----------------|:-----------------|
| pa##   | Public API       | *public-api*     |
| aa##   | Admin API        | *admin-api*      |
| ce##   | Cross-cutting    | *error-handling* |
| co##   | Cross-cutting    | *open-api*       |
| cs##   | Cross-cutting    | *security*       |
| cv##   | Cross-cutting    | *versioning*     |
