...
The domain model has [8 transactions](10_domain_model.md#transactions). Domain invariants are enforced in the application, with a fallback enforcement layer in the database.
