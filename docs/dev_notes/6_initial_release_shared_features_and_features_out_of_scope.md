# 6. Initial release: *shared* features, and features out of scope
...
- [6. Initial release: *shared* features, and features out of scope](#6-initial-release-shared-features-and-features-out-of-scope)
...
- **I WANT** the web app to serve an OpenAPI JSON document for every API release
  ...
  - at a standardized address
  - accessible to anonymous clients
- **SO THAT** a developer can generate a client for working with the API.
