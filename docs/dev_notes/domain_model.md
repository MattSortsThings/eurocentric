...
5. A **BROADCAST** has a boolean `Completed` value.
6. A **BROADCAST** has at least 2 **Competitors**.
7. Each **Competitor** in a **BROADCAST** represents a different **Participant** in the parent **CONTEST**.
8. Each **Jury** in a **BROADCAST** represents a different **Participant** in the parent **CONTEST**.
9.  Each **Televote** in a **BROADCAST** represents a different **Participant** in the parent **CONTEST**.
10. A **Jury** awards its points by ordering all the **Competitors** from first to last, excluding the **Competitor** representing the **Jury**'s **COUNTRY** if present.
11. A **Televote** awards its points by ordering all the **Competitors** from first to last, excluding the **Competitor** representing the **Televote**'s **COUNTRY** if present.
12. A **Jury** awards its points exactly once.
13. A **Televote** awards its points exactly once.
14. A **Competitor** may be disqualified from a **BROADCAST** only if no **Jury** or **Televote** has awarded its points.
15. When a **Competitor** is disqualified from a **BROADCAST**, the remaining **Competitors** update their finishing positions to close the gap but leave their running order positions unchanged.
16. A **BROADCAST** becomes `Completed` when all of its **Juries** and all of its **Televotes** have awarded their points.
