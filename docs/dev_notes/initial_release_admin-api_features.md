...
- **I want to** create a contest in the system
  - specifying
    - the contest's year
    - and its city name
    - and whether it uses televote-only semi-finals
    - and its group 0 participants
    - and its group 1 participants
    - and its group 2 participants
...
- **I want to** create a broadcast for a contest in the system
  - specifying
    - the contest ID
    - and the broadcast contest stage
    - and the competitor country IDs in performing order
...
- **I want to** be sure that a contest updates itself
  - when one of its broadcasts is completed
    - setting the corresponding broadcast memo to completed
    - and setting its status to complete
      - if it has 3 broadcast memos and they are all completed
...
- **I want to** be sure that a contest updates itself
  - when one of its broadcasts is deleted
    - removing the corresponding broadcast memo
