...
| ![Logo comprising the text "Eurovision Song Contest Basel 2025", with "V" in "Eurovision" rendered as a heart containing the Swiss flag, on a black background, surrounded by pink and blue hearts.](media/ESC-2025-logo.png) |
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
...
The 2025 Eurovision Song Contest was held in Basel, Switzerland. There were 37 participating countries, plus an additional "Rest of the World" televote. The winner was JJ with the song "Wasted Love", representing the Austrian national broadcaster ORF. The 2026 Eurovision Song Contest is therefore likely to be held in Austria.
...
All other participating countries must compete in one of the two Semi-Finals. The top 10 competing countries from each Semi-Final qualify for the Grand Final, along with the automatic qualifiers.

### Contest format

***Eurocentric* defines a contest format as a simplified set of rules from the real-life Eurovision Song Contest.**

A contest format specifies the allocation of participants to broadcasts and the voting methods that are used in each broadcast.

#### "Stockholm" format (2016-2022)

This contest format was introduced at the 2016 Eurovision Song Contest in Stockholm and was last used at the 2022 Contest in Turin.

There are two participant groups: 1 and 2. The participants are divided equally between the two groups.

- Each group 1 participant votes in, and may compete in, the First Semi-Final and the Grand Final.
- Each group 2 participant votes in, and may compete in, the Second Semi-Final and the Grand Final.

The following voting methods are used:

- In all three stages, every voting country awards a set of televote points.
- In all three stages, every voting country awards a set of jury points.

#### "Liverpool" format (2023-present)

This contest format was introduced at the 2023 Eurovision Song Contest in Liverpool and is still in use in 2025.

There are three participant groups: 0, 1 and 2. The competing participants are divided equally between two groups: 1 and 2. A non-competing "Rest of the World" pseudo-country is assigned to group 0 by itself.

- The group 0 participant votes in, but does not compete in, all three stages.
- Each group 1 participant votes in, and may compete in, the First Semi-Final and the Grand Final.
- Each group 2 participant votes in, and may compete in, the Second Semi-Final and the Grand Final.

The following voting methods are used:

- In the First Semi-Final, every voting country awards a set of televote points.
- In the Second Semi-Final, every voting country awards a set of televote points.
- In the Grand Final, every voting country awards a set of televote points.
- In the Grand Final, every voting country that is not in participant group 0 awards a set of jury points.
...
**In *Eurocentric*, a withdrawn country is disregarded.**
...
| ![Brightly lit area, with spectators seated around central stage with proscenium arch.](media/ESC-2025-arena.png) |
|:-----------------------------------------------------------------------------------------------------------------:|
|                   *The Eurovision 2025 stage in St. Jakobshalle, Basel (© EBU/Alma Bengtsson).*                   |

| ![Performers standing in a gallery overlooking a concert arena, being photographed by journalists.](media/ESC-2025-sf2-green-room.png) |
|:--------------------------------------------------------------------------------------------------------------------------------------:|
...
| ![Male singer standing on a stage lit in red and white, holding an Austrian flag, with the name of the country Austria behind him.](media/ESC-2025-jj-flag-parade.png) |
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|                       *JJ from Austria participating in the flag parade at the start of the Eurovision 2025 Grand Final (© EBU/Alma Bengtsson).*                       |


| ![Black and white image of male solo singer performing in a stage modelled to look like a small boat.](media/ESC-2025-jj-performance.png) |
|:-----------------------------------------------------------------------------------------------------------------------------------------:|
|                   *JJ from Austria performing "Wasted Love" in the Eurovision 2025 Grand Final (© EBU/Alma Bengtsson).*                   |

| ![Scoreboard with 26 ranked countries, Austria in first place.](media/ESC-2025-grand-final-scoreboard.png) |
|:----------------------------------------------------------------------------------------------------------:|
|                         *Scoreboard from the Eurovision 2025 Grand Final (© EBU).*                         |

| ![Male singer standing on a brightly lit arena stage holding a glass trophy shaped like a microphone.](media/ESC-2025-jj-trophy.png) |
|:------------------------------------------------------------------------------------------------------------------------------------:|
