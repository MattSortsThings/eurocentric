...
- [Eurovision context](#eurovision-context)
  ...
  - [How is a contest organized?](#how-is-a-contest-organized)
    ...
    - [Contest formats](#contest-formats)
      - ["Stockholm" contest format, 2016-2022](#stockholm-contest-format-2016-2022)
      - ["Liverpool" contest format, 2023-present](#liverpool-contest-format-2023-present)
...
The Eurovision Song Contest is an annual televised song contest organized by the European Broadcasting Union (EBU). The contest is between national broadcasters, each from a different country, represented by an act with a song. The country that wins the contest customarily hosts the following year's contest.
...
Two voting methods are used to determine points awarded from voting countries to competing countries: national televotes and national juries.

### Contest formats

#### "Stockholm" contest format, 2016-2022

The following voting rules were introduced for the 2016 contest in Stockholm:

- In all three stages of the contest, every voting country has a national televote.
- In all three stages, every voting country has a national jury.

#### "Liverpool" contest format, 2023-present
...
On multiple occasions in recent years, a voting country has not been able to award its televote points during a broadcast. For example, San Marino has no independent telephone network so it cannot organize a televote. Two methods have been used in recent years to create a set of televote points awards for a country that finds itself in this position:

1. An artificial televote ranking of competing countries has been generated from the televote rankings of selected countries that have historically voted in a similar manner as the affected country.
2. The affected country has a back-up jury that awards a set of points as a replacement for the televote points.

**In *Eurocentric*, all televote points are taken at face value, disregarding any substitution methods that were used.**
...
| ![A large empty concert stage in the centre of a darkened arena, lit in purple and orange.](media/ESC-2024-contest-stage.jpg) |
|:-----------------------------------------------------------------------------------------------------------------------------:|
|                 The stage for the 68th Eurovision Song Contest in Malmö, Sweden, 2024 (Peppe Andersson, SVT).                 |


| ![A singer performing in the centre of a concert stage, wearing a pink outfit and standing on top of a silver circular platform.](media/ESC-2024-nemo-performance.png) |
|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|                                    Nemo performing "The Code" for Switzerland at the 2024 Grand Final (Sarah Louise Bennett, EBU).                                     |


| ![Scoreboard showing competing countries, their finishing positions and total points.](media/ESC-2024-grand-final-results.png) |
|:------------------------------------------------------------------------------------------------------------------------------:|
|                                        The final results of the 2024 Grand Final (EBU).                                        |


|         ![A singer wearing a pink outfit holding a glass trophy.](media/ESC-2024-nemo-winner.jpg)          |
|:----------------------------------------------------------------------------------------------------------:|
| Switzerland wins the 68th Eurovision Song Contest with the song "The Code" by Nemo (Corinne Cumming, EBU). |


| ![A large concert stage in the centre of a darkened arena filled with spectators, lit in bright white and red, with the shape of mountains in the background.](media/ESC-2025-stage-design.jpg) |
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
