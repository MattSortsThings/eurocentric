...
- [9 Development plan](#9-development-plan)
  - [Development phases](#development-phases)
    ...
    - [Phase 2: Admin API features](#phase-2-admin-api-features)
    - [Phase 3: Public API features](#phase-3-public-api-features)
...
Once the version 0.x API versions are up and running, implement all cross-cutting features, i.e. those with feature scopes *errors*, *logging*, *open-api*, *security* and *versioning*.

### Phase 2: Admin API features

Define version 1.0 of the Admin API, then implement all *admin-api* features.

### Phase 3: Public API features
...
Acceptable feature scopes are: *admin-api*, *public-api*, *errors*, *logging*, *open-api*, *security* and *versioning*.
...
7. Message body must enclose a feature scope name in double quotation marks
8. Message body must reference a feature by its code and name, enclosed in double quotation marks, with no other punctuation marks
...
Implemented the "A14 Create country" feature.
