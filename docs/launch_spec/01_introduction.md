...
|    *errors*    | User error and exception handling        |
...
|   Dev   | *errors*, *logging*, *open-api*, *security*, *versioning* | The owner and developer of the system. Aims to create a robust, well-structured web application that hosts the Admin API and the Public API.                                                                                                                        |
