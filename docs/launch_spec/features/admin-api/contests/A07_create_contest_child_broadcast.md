...
- `broadcast.completed` is always `false` for a newly created contest aggregate.
- every item in `broadcast.competitors` has an empty `competitor.pointsAwards` collection for a newly created contest aggregate.
- every item in `broadcast.televotes` is `pointsAwarded=false` for a newly created contest aggregate.
- every item in `broadcast.juries` is `pointsAwarded=false` for a newly created contest aggregate.
