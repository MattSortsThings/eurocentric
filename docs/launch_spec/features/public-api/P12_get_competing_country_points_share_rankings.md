# P12 Get competing country points share rankings
...
- **As a EuroFan**
- **I want** to rank competing countries by their *points share* metric, i.e. the fraction of the available points the country received across broadcasts, receiving the query metadata and a page of rankings ordered by rank, then by country code
...
```http request
GET /public/api/{apiVersion}/rankings/competing-countries/points-share
```
