# P11. Get country points from single in range rankings
...
- **As a EuroFan**
- **I want** to rank all countries by their *points from single in range* metric
  - **i.e.** the relative frequency of points awards within a specified value range each country received from a specified voting country across broadcasts
...
4. For each group, calculate:
   ...
   - the points from single in range (rounding half-up to 6dp)
5. Rank all competing countries by descending points from single in range (using non-dense ranking, assigning equal rank to equal values)
...
```http request
GET /public/api/{apiVersion}/country-rankings/points-from-single-in-range
```
...
- [ ] Succeeds_when_specifying_votingCountryCode_CH_minPointsValue_1_maxPointsValue_8
- [ ] Succeeds_when_specifying_votingCountryCode_CH_minPointsValue_1_maxPointsValue_12
- [ ] Succeeds_when_specifying_votingCountryCode_CH_minPointsValue_8_maxPointsValue_12
- [ ] Succeeds_when_specifying_votingCountryCode_FI_minPointsValue_0_maxPointsValue_0
- [ ] Succeeds_when_specifying_votingCountryCode_FI_minPointsValue_1_maxPointsValue_12
- [ ] Succeeds_when_specifying_votingCountryCode_GB_minPointsValue_0_maxPointsValue_0
- [ ] Succeeds_when_specifying_votingCountryCode_GB_minPointsValue_1_maxPointsValue_12
- [ ] Succeeds_when_specifying_votingCountryCode_SM_minPointsValue_0_maxPointsValue_0
- [ ] Succeeds_when_specifying_votingCountryCode_SM_minPointsValue_1_maxPointsValue_12
- [ ] Succeeds_when_specifying_votingCountryCode_XX_minPointsValue_0_maxPointsValue_0
- [ ] Succeeds_when_specifying_votingCountryCode_XX_minPointsValue_1_maxPointsValue_12
...
- [ ] Succeeds_with_0_rankings_when_filtering_to_Jury_points_and_RestOfTheWorld_voting_country
