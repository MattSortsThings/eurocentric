# P22 Get voting country points share rankings
...
- **As a EuroFan**
- **I want** to rank voting countries by their *points share* metric, i.e. the fraction of the available points the country gave to a specific competing country across broadcasts, receiving the query metadata and a page of rankings ordered by rank, then by country code
...
```http request
GET /public/api/{apiVersion}/rankings/voting-countries/points-share
```
