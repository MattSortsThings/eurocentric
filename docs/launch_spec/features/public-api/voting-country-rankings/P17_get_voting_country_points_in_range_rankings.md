...
- **As a EuroFan**
- **I want** to get a page of voting countries ranked by their *points in range* metric, i.e. the relative frequency of points awards within a specific value range each country gave to a specific competing country across broadcasts
...
```http request
GET /public/api/{apiVersion}/voting-country-rankings/points-in-range
```
...
- [ ] Should_succeed_when_specifying_competingCountryCode_CH_minPoints_1_maxPoints_12
- [ ] Should_succeed_when_specifying_competingCountryCode_CH_minPoints_0_maxPoints_0
- [ ] Should_succeed_when_specifying_competingCountryCode_CH_minPoints_1_maxPoints_7
- [ ] Should_succeed_when_specifying_competingCountryCode_FI_minPoints_1_maxPoints_12
- [ ] Should_succeed_when_specifying_competingCountryCode_FI_minPoints_0_maxPoints_0
- [ ] Should_succeed_when_specifying_competingCountryCode_FI_minPoints_1_maxPoints_7
- [ ] Should_succeed_when_specifying_competingCountryCode_GB_minPoints_1_maxPoints_12
- [ ] Should_succeed_when_specifying_competingCountryCode_GB_minPoints_0_maxPoints_0
- [ ] Should_succeed_when_specifying_competingCountryCode_GB_minPoints_1_maxPoints_7
- [ ] Should_succeed_when_specifying_competingCountryCode_SI_minPoints_1_maxPoints_12
- [ ] Should_succeed_when_specifying_competingCountryCode_SI_minPoints_0_maxPoints_0
- [ ] Should_succeed_when_specifying_competingCountryCode_SI_minPoints_1_maxPoints_7
