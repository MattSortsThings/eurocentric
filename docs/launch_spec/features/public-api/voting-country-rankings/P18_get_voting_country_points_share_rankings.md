...
- **As a EuroFan**
- **I want** to get a page of voting countries ranked by their *points share* metric, i.e. the fraction of the maximum possible points each country gave to a specific competing country across broadcasts
...
```http request
GET /public/api/{apiVersion}/voting-country-rankings/points-share
```
