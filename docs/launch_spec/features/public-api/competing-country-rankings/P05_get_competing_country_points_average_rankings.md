...
- [P05. Get competing country points average rankings](#p05-get-competing-country-points-average-rankings)
...
- **As a EuroFan**
- **I want** to get a page of competing countries ranked by their *points average* metric, i.e. the average individual points award value each country received across broadcasts
...
```http request
GET /public/api/{apiVersion}/competing-country-rankings/points-average
```
...
- [ ] Should_succeed_when_filtering_by_votingCountryCode_XX
