...
- [P03. Get broadcast competitor points share rankings](#p03-get-broadcast-competitor-points-share-rankings)
...
- **As a EuroFan**
- **I want** to get a page of broadcast competitors ranked by their *points share* metric, i.e. the fraction of the maximum possible points each competitor received in their broadcast
...
```http request
GET /public/api/{apiVersion}/broadcast-competitor-rankings/points-share
```
...
**GetBroadcastCompetitorPointsShareRankings endpoint...**
