...
- [P01. Get broadcast competitor points average rankings](#p01-get-broadcast-competitor-points-average-rankings)
...
- **As a EuroFan**
- **I want** to get a page of broadcast competitors ranked by their *points average* metric, i.e. the average individual points award value each competitor received in their broadcast
...
```http request
GET /public/api/{apiVersion}/broadcast-competitor-rankings/points-average
```
