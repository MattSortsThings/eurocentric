...
- `scoreboardRows` is sorted by `broadcastScoreboardRow.performingSpot`.
- `broadcastScoreboardRow.juryPoints` may be null.
- `broadcastScoreboardRow.juryRank` may be null.
