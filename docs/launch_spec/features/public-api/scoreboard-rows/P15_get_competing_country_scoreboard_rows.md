...
- `scoreboardRows` is sorted by `competingcountryScoreboardRow.broadcastDate`.
- `competingcountryScoreboardRow.juryPoints` may be null.
- `competingcountryScoreboardRow.juryRank` may be null.
