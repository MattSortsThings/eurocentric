# P23 Get voting country points similarity rankings
...
- **As a EuroFan**
- **I want** to rank voting countries by their *points similarity* metric, i.e. the cosine similarity between the normalized televote and jury points awards the country gave across broadcasts, receiving the query metadata and a page of rankings ordered by rank, then by country code
...
```http request
GET /public/api/{apiVersion}/rankings/voting-countries/points-similarity
```
...
|:-----------------------|:-------------:|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `competingCountryCode` |    string     |    no    | Filters the competing country code when not null. Must be a string of 2 upper-case letters when not null.                                                                                               |
