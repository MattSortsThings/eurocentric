# P10 Get competing country points average rankings
...
- **As a EuroFan**
- **I want** to rank competing countries by their *points average* metric, i.e. the average points award value the country received across broadcasts, receiving the query metadata and a page of rankings ordered by rank, then by country code
...
```http request
GET /public/api/{apiVersion}/rankings/competing-countries/points-average
```
...
**GetCompetingCountryPointsAverageRankings endpoint...**
