# P20 Get voting country points average rankings
...
- **As a EuroFan**
- **I want** to rank voting countries by their *points average* metric, i.e. the average points award value the country gave to a specific competing country across broadcasts, receiving the query metadata and a page of rankings ordered by rank, then by country code
