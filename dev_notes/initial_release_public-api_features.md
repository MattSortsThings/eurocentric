...
- [Initial release: *public-api* features](#initial-release-public-api-features)
  - [Broadcasts](#broadcasts)
    - [P01: Get Available Broadcasts](#p01-get-available-broadcasts)
  ...
  - [Contests](#contests)
    - [P06: Get Available Contests](#p06-get-available-contests)
  - [Countries](#countries)
    - [P07: Get Available Countries](#p07-get-available-countries)
...
### P01: Get Available Broadcasts

**User Story**

- **As** a Euro-Fan
- **I want to** retrieve all the available broadcasts
...
### P06: Get Available Contests

**User Story**

- **As** a Euro-Fan
- **I want to** retrieve all the available contests
  - ordered by contest year
- **So that** I can plan my queries.

## Countries

### P07: Get Available Countries

**User Story**

- **As** a Euro-Fan
- **I want to** retrieve all the available countries
