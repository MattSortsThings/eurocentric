# 04c: Initial release *shared* features, and features out of scope

This document contains the shared feature specification for the initial release of *Eurocentric*.

- [04c: Initial release *shared* features, and features out of scope](#04c-initial-release-shared-features-and-features-out-of-scope)
...
The system is designed so that these features could be incorporated in the future as cross-cutting functionality.
