...
/*
-- =============================================
-- Function:    dbo.usp_get_competing_country_points_average_rankings
-- Author:      Matt Tantony
...
--
--  Points average is a DECIMAL(18,6) between 0 and 12, calculated as the average individual points value the competing
--  country received across broadcasts.
--
