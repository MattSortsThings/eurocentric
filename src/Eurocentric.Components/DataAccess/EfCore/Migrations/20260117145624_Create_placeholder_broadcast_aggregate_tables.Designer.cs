...
namespace Eurocentric.Components.DataAccess.EfCore.Migrations
{
    ...
    [Migration("20260117145624_Create_placeholder_broadcast_aggregate_tables")]
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("contest", "placeholder", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_contest_grand_final_voting_rules_Enum", "[grand_final_voting_rules] IN ('TelevoteAndJury', 'TelevoteOnly')");

                            t.HasCheckConstraint("CK_contest_semi_final_voting_rules_Enum", "[semi_final_voting_rules] IN ('TelevoteAndJury', 'TelevoteOnly')");
                        });
                });
            ...
            modelBuilder.Entity("Eurocentric.Domain.Aggregates.Placeholders.Contest", b =>
                {
                    b.OwnsMany("Eurocentric.Domain.Aggregates.Placeholders.BroadcastMemo", "BroadcastMemos", b1 =>
                        {
                            ...
                            b1.ToTable("contest_broadcast_memo", "placeholder", t =>
                                {
                                    t.HasCheckConstraint("CK_contest_broadcast_memo_contest_stage_Enum", "[contest_stage] IN ('GrandFinal', 'SemiFinal1', 'SemiFinal2')");
                                });
                    ...
                    b.OwnsOne("Eurocentric.Domain.Aggregates.Placeholders.GlobalTelevote", "GlobalTelevote", b1 =>
                        {
                            b1.Property<Guid>("ContestId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("Eurocentric.Domain.Aggregates.Placeholders.Participant", "Participants", b1 =>
                        {
                            b1.Property<Guid>("ContestId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("contest_id");
