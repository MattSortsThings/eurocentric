        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    voting_rules = table.Column<string>(
                        type: "varchar(15)",
                        unicode: false,
                        maxLength: 15,
                        nullable: false
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint(
                        ...
                        "[contest_stage] IN ('GrandFinal', 'SemiFinal1', 'SemiFinal2')"
                    );
                    table.CheckConstraint(
                        "CK_broadcast_voting_rules_Enum",
                        "[voting_rules] IN ('TelevoteAndJury', 'TelevoteOnly')"
                    );
                }
            );
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    competitor_country_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    broadcast_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                {
                    table
                        .PrimaryKey("PK_broadcast_competitor", x => new { x.broadcast_id, x.competitor_country_id })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_broadcast_competitor_points_award_points_value", "[points_value] >= 0");
                    table.CheckConstraint(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "broadcast_id", "competitor_country_id" },
                        onDelete: ReferentialAction.Cascade
                    );
                }
            );
