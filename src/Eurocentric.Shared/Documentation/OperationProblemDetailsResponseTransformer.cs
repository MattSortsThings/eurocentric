...
internal sealed class OperationProblemDetailsResponseTransformer : IOpenApiOperationTransformer
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            if (IsNotProblemStatusCode(statusCode))
            {
                continue;
            }
    ...
    private static bool IsNotProblemStatusCode(string statusCode) =>
        statusCode[0] is var initialChar && initialChar != '4' && initialChar != '5';
