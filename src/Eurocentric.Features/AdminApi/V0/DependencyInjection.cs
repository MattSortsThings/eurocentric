...
{
    /// <summary>
    ///     Adds the OpenAPI documents for version 0 of the Admin API to the application service descriptor collection.
    /// </summary>
    ...
    {
        services.AddOpenApi(OpenApiDocumentNames.AdminApiV0Point1, options =>
        {
        ...
        services.AddOpenApi(OpenApiDocumentNames.AdminApiV0Point2, options =>
        {
            options.ShouldInclude = description =>
                description.GroupName == ApiReleases.EndpointGroupName
