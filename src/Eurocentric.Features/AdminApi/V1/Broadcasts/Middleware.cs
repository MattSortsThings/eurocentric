...
internal static class Middleware
{
    ...
    internal static void MapBroadcastsEndpoints(this IEndpointRouteBuilder builder)
    {
        ...
        group.MapPatch("/{broadcastId:guid}/disqualify", DisqualifyCompetitorFeature.ExecuteAsync)
            .WithName(EndpointNames.Routes.Broadcasts.DisqualifyCompetitor)
            .WithSummary("Disqualify a competitor in a broadcast")
            .WithDescription("Disqualifies a competitor from an existing broadcast before awarding points.")
            .HasApiVersion(1, 0)
            .Produces(StatusCodes.Status204NoContent)
            .ProducesProblem(StatusCodes.Status400BadRequest)
            .ProducesProblem(StatusCodes.Status404NotFound)
