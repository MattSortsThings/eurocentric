...
{
    /// <summary>
    ///     Adds the Admin API v1.x OpenAPI documents to the application service descriptor collection.
    /// </summary>
    /// <param name="services">Contains service descriptors for the application.</param>
    internal static void AddV1OpenApiDocuments(this IServiceCollection services) =>
        services.AddOpenApi("admin-api-v1.0", ConfigureAdminApiV1Point0);

    private static void ConfigureAdminApiV1Point0(OpenApiOptions options)
    {
        ...
        options.AddDocumentTransformer<ApiKeySecurityDocumentTransformer>()
            ...
            .AddDocumentTransformer(new ApiReleaseDocumentTransformer("/admin/api/v1.0"));
    }
}
