...
public sealed record CompetitorPointsAverageFilteringMetadata : IExampleProvider<CompetitorPointsAverageFilteringMetadata>
{
    ...
    public static CompetitorPointsAverageFilteringMetadata CreateExample() => new()
    {
