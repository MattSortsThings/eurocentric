...
public sealed record CompetingCountryPointsInRangeQueryMetadata : IExampleProvider<CompetingCountryPointsInRangeQueryMetadata>
{
    ...
    public static CompetingCountryPointsInRangeQueryMetadata CreateExample() => new()
    {
