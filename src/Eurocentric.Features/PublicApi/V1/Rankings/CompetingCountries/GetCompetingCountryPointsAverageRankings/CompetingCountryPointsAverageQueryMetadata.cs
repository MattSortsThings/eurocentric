...
public sealed record CompetingCountryPointsAverageQueryMetadata : IExampleProvider<CompetingCountryPointsAverageQueryMetadata>
{
    ...
    public static CompetingCountryPointsAverageQueryMetadata CreateExample() => new()
    {
