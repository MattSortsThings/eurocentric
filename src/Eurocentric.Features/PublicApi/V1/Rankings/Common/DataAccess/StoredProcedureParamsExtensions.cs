...
internal static class StoredProcedureParamsExtensions
{
    ...
    internal static ErrorOr<StoredProcedureParams> WithCompetingCountryCodeParamFrom(this ErrorOr<StoredProcedureParams> p,
        ICompetingCountryFilteringQuery query)
    {
