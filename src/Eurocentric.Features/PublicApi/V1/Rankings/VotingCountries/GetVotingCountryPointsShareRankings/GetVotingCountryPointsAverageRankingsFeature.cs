...
internal static class GetVotingCountryPointsShareRankingsFeature
{
    internal static async Task<IResult> ExecuteAsync([AsParameters] GetVotingCountryPointsShareRankingsRequest queryParams,
        IRequestResponseBus bus,
        CancellationToken cancellationToken = default) =>
        await bus.SendWithResponseMapperAsync(queryParams.ToQuery(), TypedResults.Ok, cancellationToken);

    private static Query ToQuery(this GetVotingCountryPointsShareRankingsRequest queryParams) => new()
    {
    ...
    private static VotingCountryPointsShareQueryMetadata ToQueryMetadata(this Query query) => new()
    {
    ...
    private static async Task<(VotingCountryPointsShareRanking[] rankings, PaginationMetadata pagination)> RunAsync(
        this IDbStoredProcedureRunner procRunner,
        StoredProcedureParams procParams,
        CancellationToken cancellationToken)
    {
        VotingCountryPointsShareRanking[] rankings = await procRunner.ExecuteAsync<VotingCountryPointsShareRanking>(
            DbStoredProcedures.Dbo.GetVotingCountryPointsShareRankings,
            procParams,
            cancellationToken);
    ...
    internal sealed record Query : IQuery<GetVotingCountryPointsShareRankingsResponse>,
        ...
        : IQueryHandler<Query, GetVotingCountryPointsShareRankingsResponse>
    {
        public async Task<ErrorOr<GetVotingCountryPointsShareRankingsResponse>> OnHandle(Query query,
            ...
            .Then(tuple => new GetVotingCountryPointsShareRankingsResponse(tuple.rankings,
