...
/// <summary>
///     Represents a single points award from a voter to a competitor in a broadcast.
/// </summary>
public abstract class PointsAward : ValueObject
{
    protected PointsAward(CountryId votingCountryId, PointsValue pointsValue)
    {
