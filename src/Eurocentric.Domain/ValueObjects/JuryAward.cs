...
/// <summary>
///     A points award given by a jury in a broadcast.
/// </summary>
public sealed class JuryAward : CompoundValueObject
{
    /// <summary>
    ///     Initializes a new <see cref="JuryAward" /> instance.
    /// </summary>
    ...
    public JuryAward(CountryId votingCountryId, PointsValue pointsValue)
    {
