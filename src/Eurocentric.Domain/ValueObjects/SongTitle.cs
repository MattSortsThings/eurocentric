...
/// <summary>
///     Contains a song's title.
/// </summary>
public sealed class SongTitle : ValueObject
{
    ...
    ///     system. A legal song title value is a non-empty, non-whitespace string of no more than 200 characters.
    /// </remarks>
    /// <param name="value">
