...
public interface IListingsGateway
{
    ...
    /// <summary>
    ///     Asynchronously retrieves the result listings for a specified competing country.
    /// </summary>
    /// <param name="query">The query parameters.</param>
    /// <param name="cancellationToken">
    ///     A <see cref="CancellationToken" /> to observe while waiting for the asynchronous listing operation to
    ...
    ///     the listings result object <i>or</i> an error.
    /// </returns>
    Task<Result<CompetingCountryResultListings, IDomainError>> GetCompetingCountryResultListingsAsync(
