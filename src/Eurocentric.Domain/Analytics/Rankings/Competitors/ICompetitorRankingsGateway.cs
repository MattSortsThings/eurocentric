...
public interface ICompetitorRankingsGateway
{
    ...
    /// <summary>
    ///     Asynchronously ranks competitors in broadcasts by descending points consensus.
    /// </summary>
    /// <param name="query">The query parameters.</param>
    /// <param name="cancellationToken">
    ///     A <see cref="CancellationToken" /> to observe while waiting for the asynchronous ranking operation to
    ...
    /// <summary>
    ///     Asynchronously ranks competitors in broadcasts by descending points in range.
    /// </summary>
    /// <param name="query">The query parameters.</param>
    /// <param name="cancellationToken">
    ///     A <see cref="CancellationToken" /> to observe while waiting for the asynchronous ranking operation to
    ...
    /// <summary>
    ///     Asynchronously ranks competitors in broadcasts by descending points share.
    /// </summary>
    /// <param name="query">The query parameters.</param>
    /// <param name="cancellationToken">
    ///     A <see cref="CancellationToken" /> to observe while waiting for the asynchronous ranking operation to
