...
public sealed class BroadcastId : ValueObject
{
    ...
    /// </remarks>
    /// <param name="dateTimeOffset">The point in time at which the <see cref="BroadcastId" /> is requested.</param>
    /// <returns>A new <see cref="BroadcastId" /> instance.</returns>
    public static BroadcastId Create(DateTimeOffset dateTimeOffset) => new(Guid.CreateVersion7(dateTimeOffset));
