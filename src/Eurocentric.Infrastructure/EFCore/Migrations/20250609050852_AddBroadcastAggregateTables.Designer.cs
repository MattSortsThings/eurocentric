...
namespace Eurocentric.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20250609050852_AddBroadcastAggregateTables")]
            ...
            modelBuilder.Entity("Eurocentric.Domain.Broadcasts.Broadcast", b =>
                {
                    ...
                    b.ToTable("broadcast", "euro", t =>
                        {
                            t.HasCheckConstraint("ck_broadcast_broadcast_date", "[broadcast_date] BETWEEN '2016-01-01' AND '2050-12-31'");

                            t.HasCheckConstraint("ck_broadcast_broadcast_status_enum", "[broadcast_status] IN (0, 1, 2)");
                    ...
                    b.OwnsMany("Eurocentric.Domain.Broadcasts.Competitor", "Competitors", b1 =>
                        {
                            ...
                            b1.ToTable("broadcast_competitor", "euro", t =>
                                {
                            ...
                            b1.OwnsMany("Eurocentric.Domain.ValueObjects.JuryAward", "JuryAwards", b2 =>
                                {
                                    ...
                                    b2.ToTable("broadcast_competitor_jury_award", "euro", t =>
                                        {
                            ...
                            b1.OwnsMany("Eurocentric.Domain.ValueObjects.TelevoteAward", "TelevoteAwards", b2 =>
                                {
                                    ...
                                    b2.ToTable("broadcast_competitor_televote_award", "euro", t =>
                                        {
                    ...
                    b.OwnsMany("Eurocentric.Domain.Broadcasts.Jury", "Juries", b1 =>
                        {
                            ...
                            b1.ToTable("broadcast_jury", "euro");
                    ...
                    b.OwnsMany("Eurocentric.Domain.Broadcasts.Televote", "Televotes", b1 =>
                        {
                            ...
                            b1.ToTable("broadcast_televote", "euro");
