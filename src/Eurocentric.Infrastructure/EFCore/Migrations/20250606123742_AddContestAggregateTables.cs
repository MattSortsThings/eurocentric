        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_contest_contest_status_enum", "[contest_status] IN (0, 1, 2)");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_contest_child_broadcast", x => x.id)
                        .Annotation("SqlServer:Clustered", true);
                    table.CheckConstraint("ck_contest_broadcast_memo_broadcast_status_enum", "[broadcast_status] IN (0, 1, 2)");
                    table.CheckConstraint("ck_contest_broadcast_memo_contest_stage_enum", "[contest_stage] IN (0, 1, 2)");
                    table.ForeignKey(
