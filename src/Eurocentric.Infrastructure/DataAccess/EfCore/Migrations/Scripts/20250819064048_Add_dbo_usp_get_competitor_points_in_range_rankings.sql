/*
    Creates the stored procedure dbo.usp_get_competitor_points_in_range_rankings.
*/
...
BEGIN
    ...
    WITH
        ...
        t2 AS (SELECT t1.competing_country_id,
                      t1.broadcast_id,
                      t1.contest_id,
                      SUM(t1.points_award_in_range) AS points_awards_in_range,
        ...
        t3 AS (SELECT t2.competing_country_id,
                      t2.broadcast_id,
                      t2.contest_id,
                      CAST(t2.points_awards_in_range AS FLOAT) / t2.points_awards AS points_in_range,
                      t2.points_awards_in_range,
                      t2.points_awards
               FROM t2)
