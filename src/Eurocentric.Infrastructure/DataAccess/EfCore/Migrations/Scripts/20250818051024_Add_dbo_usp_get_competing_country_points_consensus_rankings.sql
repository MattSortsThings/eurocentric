...
Description   : Ranks each competing country by descending POINTS CONSENSUS metric, i.e. the cosine similarity between 
                all the individual jury points awards it has received and all the individual televote points it has 
                received, using each voting country in each broadcast as a vector dimension for comparison. Returns a 
                page of rankings.
