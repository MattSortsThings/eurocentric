...
{
    /// <inheritdoc />
    public partial class AddPlaceholderQueryableJuryAwardTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "placeholder_queryable_jury_award",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_placeholder_queryable_jury_award", x => new { x.competing_country_code, x.voting_country_code, x.contest_year, x.contest_stage });
                    table.CheckConstraint("ck_placeholder_queryable_jury_award_contest_stage_enum", "[contest_stage] IN (0,1,2)");
                });

            migrationBuilder.CreateIndex(
                name: "ix_placeholder_queryable_jury_award_competing_country_code",
                table: "placeholder_queryable_jury_award",
                column: "competing_country_code");

            migrationBuilder.CreateIndex(
                name: "ix_placeholder_queryable_jury_award_contest_stage",
                table: "placeholder_queryable_jury_award",
                column: "contest_stage");

            migrationBuilder.CreateIndex(
                name: "ix_placeholder_queryable_jury_award_contest_year",
                table: "placeholder_queryable_jury_award",
                column: "contest_year");

            migrationBuilder.CreateIndex(
                name: "ix_placeholder_queryable_jury_award_voting_country_code",
                table: "placeholder_queryable_jury_award",
