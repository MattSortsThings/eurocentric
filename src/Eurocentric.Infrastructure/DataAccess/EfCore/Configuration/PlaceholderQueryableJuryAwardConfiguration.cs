...
internal sealed class PlaceholderQueryableJuryAwardConfiguration : IEntityTypeConfiguration<QueryableJuryAward>
{
    public void Configure(EntityTypeBuilder<QueryableJuryAward> builder)
    {
        builder.ToTable("placeholder_queryable_jury_award");
    ...
    private static void AddContestStageEnumCheckConstraint(TableBuilder<QueryableJuryAward> builder) =>
        builder.HasCheckConstraint("ck_placeholder_queryable_jury_award_contest_stage_enum",
