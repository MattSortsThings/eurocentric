...
public static class GetQueryableCountriesV0Point2
{
    ...
    internal static IEndpointRouteBuilder MapGetQueryableCountriesV0Point2(this IEndpointRouteBuilder builder)
    {
        builder.MapGet("v0.2/queryables/countries", ExecuteAsync)
            .WithName("PublicApi.V0.2.Queryables.GetQueryableCountries")
