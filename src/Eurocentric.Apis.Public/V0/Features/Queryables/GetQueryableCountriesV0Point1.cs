...
public static class GetQueryableCountriesV0Point1
{
    ...
    internal static IEndpointRouteBuilder MapGetQueryableCountriesV0Point1(this IEndpointRouteBuilder builder)
    {
        builder.MapGet("v0.1/queryables/countries", ExecuteAsync)
            .WithName("PublicApi.V0.1.Queryables.GetQueryableCountries")
