...
public static class GetQueryableBroadcastsV0Point2
{
    ...
    internal static IEndpointRouteBuilder MapGetQueryableBroadcastsV0Point2(this IEndpointRouteBuilder builder)
    {
        builder.MapGet("v0.2/queryables/broadcasts", ExecuteAsync)
            .WithName("PublicApi.V0.2.Queryables.GetQueryableBroadcasts")
