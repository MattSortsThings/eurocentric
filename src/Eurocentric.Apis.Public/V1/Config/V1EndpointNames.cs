...
internal static class V1EndpointNames
{
    ...
    internal static class CompetitorRankings
    {
        ...
        internal const string GetCompetitorPointsInRangeRankings = "PublicApi.V1.GetCompetitorPointsInRangeRankings";
    ...
    internal static class VotingCountryRankings
    {
        ...
        internal const string GetVotingCountryPointsInRangeRankings =
            "PublicApi.V1.GetVotingCountryPointsInRangeRankings";
