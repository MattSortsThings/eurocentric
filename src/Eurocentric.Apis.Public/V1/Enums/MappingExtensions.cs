...
using ApiContestStageFilter = Eurocentric.Apis.Public.V1.Enums.ContestStageFilter;
using ApiVotingMethodFilter = Eurocentric.Apis.Public.V1.Enums.VotingMethodFilter;
