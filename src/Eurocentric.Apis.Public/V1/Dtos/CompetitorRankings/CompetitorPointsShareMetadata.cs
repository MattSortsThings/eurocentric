...
/// </summary>
public sealed record CompetitorPointsShareMetadata : IDtoSchemaExampleProvider<CompetitorPointsShareMetadata>
{
    /// <summary>
    ...
    public static CompetitorPointsShareMetadata CreateExample() =>
        new()
        {
    ...
    public bool Equals(CompetitorPointsShareMetadata? other)
    {
        if (other is null)
        {
            return false;
