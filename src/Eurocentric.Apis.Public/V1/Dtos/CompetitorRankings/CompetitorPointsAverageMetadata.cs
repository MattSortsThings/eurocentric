...
/// </summary>
public sealed record CompetitorPointsAverageMetadata : IDtoSchemaExampleProvider<CompetitorPointsAverageMetadata>
{
    /// <summary>
    ...
    public static CompetitorPointsAverageMetadata CreateExample() =>
        new()
        {
    ...
    public bool Equals(CompetitorPointsAverageMetadata? other)
    {
        if (other is null)
        {
            return false;
