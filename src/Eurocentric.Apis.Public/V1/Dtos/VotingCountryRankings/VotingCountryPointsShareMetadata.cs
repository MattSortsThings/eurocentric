...
/// </summary>
public sealed record VotingCountryPointsShareMetadata : IDtoSchemaExampleProvider<VotingCountryPointsShareMetadata>
{
    /// <summary>
    ...
    public static VotingCountryPointsShareMetadata CreateExample() =>
        new()
        {
    ...
    public bool Equals(VotingCountryPointsShareMetadata? other)
    {
        if (other is null)
        {
            return false;
