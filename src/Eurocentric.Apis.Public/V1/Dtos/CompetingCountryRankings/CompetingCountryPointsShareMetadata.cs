...
public sealed record CompetingCountryPointsShareMetadata
    : IDtoSchemaExampleProvider<CompetingCountryPointsShareMetadata>
{
    /// <summary>
    ...
    public static CompetingCountryPointsShareMetadata CreateExample() =>
        new()
        {
    ...
    public bool Equals(CompetingCountryPointsShareMetadata? other)
    {
        if (other is null)
        {
            return false;
