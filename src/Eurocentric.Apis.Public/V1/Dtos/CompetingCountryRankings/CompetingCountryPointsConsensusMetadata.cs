...
/// </summary>
public sealed record CompetingCountryPointsConsensusMetadata
    : IDtoSchemaExampleProvider<CompetingCountryPointsConsensusMetadata>
{
    /// <summary>
    ...
    public static CompetingCountryPointsConsensusMetadata CreateExample() =>
        new()
        {
    ...
    public bool Equals(CompetingCountryPointsConsensusMetadata? other)
    {
        if (other is null)
        {
            return false;
