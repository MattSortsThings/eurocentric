...
public sealed record CompetingCountryPointsInRangeMetadata
    : IDtoSchemaExampleProvider<CompetingCountryPointsInRangeMetadata>
{
    /// <summary>
    ...
    public static CompetingCountryPointsInRangeMetadata CreateExample() =>
        new()
        {
            MinPoints = 1,
            MaxPoints = 12,
    ...
    public bool Equals(CompetingCountryPointsInRangeMetadata? other)
    {
        if (other is null)
        {
            return false;
